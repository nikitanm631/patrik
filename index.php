...
<html lang="en">
<head>
	<title>Patrik Ocean </title>
	<meta name = "keywords" content = "">
	<meta name = "description" content = " in navi mumbai">
		    ...
		    <div class="row">
		        <div class="col-md-3 col-sm-6">
		            <div class="serviceBox">
		                ...
		                <h3 class="title">Crew <br> Management</h3>
		                <p class="description">
		        ...
		        <div class="col-md-3 col-sm-6">
		            <div class="serviceBox">
		                ...
		                <h3 class="title">Technical <br> Management</h3>
		                <p class="description">
		                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium consequuntur, deleniti eaque excepturi.
		                </p>
		            </div>
		            ...
		            <div class="serviceBox">
		                <div class="service-icon"><i class="fa fa-rocket"></i></div>
		                <h3 class="title">Offshore <br> Management</h3>
		                <p class="description">
		                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium consequuntur, deleniti eaque excepturi.
		                </p>
		            </div>
		            ...
		            <div class="serviceBox">
		                <div class="service-icon"><i class="fa fa-rocket"></i></div>
		                <h3 class="title">Flag State Documentation Services</h3>
		                <p class="description">
		                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium consequuntur, deleniti eaque excepturi.
		                </p>
		            </div>
		...
		<!-- <section class="appointment-sec pb-40">
			<div class="container-fluid plr-0">
				<div class="row">
					...
					<div class="col-md-6 plr-100">
						<h2><span class="text-red"><b>Get in</b> </span> <span class="text-blue"><b>Touch</b> </span> </h2>

						<br>

						<div class="shadow pad bg-white">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<p>We are committed towards substantial continuous professional development, to meet the requirements of our customers.</p>
				</div>
				<div class="col-md-3">
